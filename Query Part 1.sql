...
-- menampilkan semua data dari tabel borrowing yang di full outer join kan ke tabel have dengan number of copies lebih dari 4
SELECT *
FROM borrowing
...
-- menampilkan rata-rata, total, harga tertinggi dan harga terendah dari total harga table purchasing dimana payment method nya transfer tunai
...
-- menampilkan penalty fee terendah dan tertinggi dari member yang meminjam buku di antara bulan Jan
...
-- menampilkan tanggal meminjam dan member id yang memiliki penalty fee terkecil
